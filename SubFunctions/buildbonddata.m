...
function [c,BondType,BFmultiplier]=buildbonddata(bondlist,NumFamMembVector,MaterialFlag)
...
%% Main body of buildbonddata

c=zeros(nBonds,1);              % Initialise bond stiffness vector
...
for kBond=1:nBonds
    ...
    c(kBond)=StiffeningFactor*ctemp;                                                                  % Correct the bond stiffness
